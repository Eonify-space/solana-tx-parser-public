...
import { decodeSetTransferFeeInstruction, getAccountDataSizeLayout } from "./programs/token-extensions";
...
function decodeTokenInstruction(instruction: TransactionInstruction): ParsedInstruction<SplToken> {
	...
	switch (decoded) {
		case spl.TokenInstruction.InitializeMint: {
			let decodedIx: spl.DecodedInitializeMintInstruction | spl.DecodedInitializeMintInstructionUnchecked;
			try {
		...
		case spl.TokenInstruction.InitializeAccount: {
			let decodedIx: spl.DecodedInitializeAccountInstruction | spl.DecodedInitializeAccountInstructionUnchecked;
			try {
		...
		case spl.TokenInstruction.InitializeMultisig: {
			let decodedIx: spl.DecodedInitializeMultisigInstruction | spl.DecodedInitializeMultisigInstructionUnchecked;
			try {
		...
		case spl.TokenInstruction.Transfer: {
			let decodedIx: spl.DecodedTransferInstruction | spl.DecodedTransferInstructionUnchecked;
			try {
		...
		case spl.TokenInstruction.Approve: {
			let decodedIx: spl.DecodedApproveInstruction | spl.DecodedApproveInstructionUnchecked;
			try {
		...
		case spl.TokenInstruction.Revoke: {
			let decodedIx: spl.DecodedRevokeInstruction | spl.DecodedRevokeInstructionUnchecked;
			try {
		...
		case spl.TokenInstruction.SetAuthority: {
			let decodedIx: spl.DecodedSetAuthorityInstruction | spl.DecodedSetAuthorityInstructionUnchecked;
			try {
		...
		case spl.TokenInstruction.MintTo: {
			let decodedIx: spl.DecodedMintToInstruction | spl.DecodedMintToInstructionUnchecked;
			try {
		...
		case spl.TokenInstruction.Burn: {
			let decodedIx: spl.DecodedBurnInstruction | spl.DecodedBurnInstructionUnchecked;
			try {
		...
		case spl.TokenInstruction.CloseAccount: {
			let decodedIx: spl.DecodedCloseAccountInstruction | spl.DecodedCloseAccountInstructionUnchecked;
			try {
		...
		case spl.TokenInstruction.FreezeAccount: {
			let decodedIx: spl.DecodedFreezeAccountInstruction | spl.DecodedFreezeAccountInstructionUnchecked;
			try {
		...
		case spl.TokenInstruction.ThawAccount: {
			let decodedIx: spl.DecodedThawAccountInstruction | spl.DecodedThawAccountInstructionUnchecked;
			try {
		...
		case spl.TokenInstruction.InitializeImmutableOwner: {
			let decodedIx: spl.DecodedInitializeImmutableOwnerInstruction | spl.DecodedInitializeImmutableOwnerInstructionUnchecked;
			try {
		...
		case spl.TokenInstruction.AmountToUiAmount: {
			let decodedIx: spl.DecodedAmountToUiAmountInstruction | spl.DecodedAmountToUiAmountInstructionUnchecked;
			try {
